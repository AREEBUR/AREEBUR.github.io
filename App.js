...
function Person (person_name, person_age) {
 ...
 const person1 = new Person("Areeb",18);
 const person2 = new Person("Ahmed", 15);
...
function Census(person_name, person_gender, person_education, person_profession, person_address){
 ...
 const personA = new Census("Areeb", person_gender, person_education, person_profession, person_address);
